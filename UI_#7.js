...
var hideFirstField = function() {
	var firstField = $("div[data-name='Поле 1']");
	var flag = $("div[data-name='Поле 2']").find("input[type='checkbox']");
	if ($(flag).attr("checked")) {
		showViewElementColumn(firstField);
	} else {
		hideViewElementColumn(firstField);
	}
}

scopes.onView(hideFirstField);
